...
function updateDeskList(desks) {
    ...
    // Funktion zum Hinzufügen eines Schreibtischs mit einer Verzögerung
    async function addDeskWithDelay(desk) {
    ...
    // Schleife durch die Schreibtische mit Verzögerung zwischen den Iterationen
    desks.forEach((desk, index) => {
        setTimeout(() => {
            addDeskWithDelay(desk);
        }, index * 100); // Verzögerung von 500 Millisekunden zwischen den Schreibtischen (kann angepasst werden)
    });
}